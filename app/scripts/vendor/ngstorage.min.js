/*! ngstorage 0.3.9 | Copyright (c) 2015 Gias Kay Lee | MIT License */ ! function ( a, b ) {
	"use strict";
	...
	function b( b ) {
		return function () {
			...
			this.setSerializer = function ( a ) {
				...
				var k, l, m = c.length,
					n = j( b ) || ( h.warn( "This browser does not support Web Storage!" ), {
						setItem: a.noop,
						getItem: a.noop
					} ),
					o = {
	...
	return a = a && a.module ? a : window.angular, a.module( "ngStorage", [] )
		.provider( "$localStorage", b( "localStorage" ) )
		.provider( "$sessionStorage", b( "sessionStorage" ) )
} );
